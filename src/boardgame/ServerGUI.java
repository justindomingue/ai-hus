...
implements BoardPanel.BoardPanelListener  {
    ...
    protected static final String[] PLAYER_CLASSES = {"hus.RandomHusPlayer", "student_player.StudentPlayer", "student_player.StudentPlayer2", "student_player.StudentPlayer3"};
